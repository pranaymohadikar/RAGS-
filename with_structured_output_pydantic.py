...
class Review(BaseModel):
    ...
    key_themes : list[str] = Field(description = "write down all the key themes of te review")
    summary: str = Field(description = "detailed summary of the review")
    sentiment:str = Field(description = "return the sentimnet")
